...
extern void LPUART0_MyDriverIRQHandler(void);
...
DEFINE_DEFAULT_IRQ_HANDLER(LPUART0_MyDriverIRQHandler);
...
DEFINE_IRQ_HANDLER(LPUART0_IRQHandler, LPUART0_MyDriverIRQHandler);

...
CCRS232Task::CCRS232Task(TEDROOMComponentID id,
...
void CCRS232Task::EDROOMBehaviour()
{
...
bool CCRS232Task::EDROOMIsComponentFinished()
{
...
void CCRS232Task::CEDROOMMemory::SetMemory(TEDROOMUInt32 numMessages_ ,

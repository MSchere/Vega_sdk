...
CCLEDTask::CCLEDTask(TEDROOMComponentID id,
...
void CCLEDTask::EDROOMBehaviour()
{
...
bool CCLEDTask::EDROOMIsComponentFinished()
{
...
void CCLEDTask::CEDROOMMemory::SetMemory(TEDROOMUInt32 numMessages_ ,

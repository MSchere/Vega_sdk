...
CCKeyScanTask::CCKeyScanTask(TEDROOMComponentID id,
...
int CCKeyScanTask::EDROOMConfig()
{
...
void CCKeyScanTask::EDROOMBehaviour()
{
...
bool CCKeyScanTask::EDROOMIsComponentFinished()
{
...
void CCKeyScanTask::CEDROOMMemory::SetMemory(TEDROOMUInt32 numMessages_ ,

...
public:
	...
	// ********************************
	// Handling IRQ vector 7

	//! Event for trigger the bottom half associated to the IRQ vector 7
	static Pr_IRQEvent	EDROOMEventIRQ7;
	//! Binary Semaphore for signal the end of the bottom half of the IRQ vector 7
	static Pr_SemaphoreBin	EDROOMSemEndIRQ7;
	//! IRQ Handler for the IRQ vector 7
	static Pr_IRQHandler_RetType	EDROOMIRQ7Handler(void);
	//! Top Half Function for IRQ Handler  7
	static void	EDROOMIRQ7HandlerTopHalfFunction(void);
	//! Idle IRQ Handler for the IRQ vector 7
	static Pr_IRQHandler_RetType	EDROOMIRQ7IdleHandler(void);
	//! Bottom Half Task Function for the IRQ vector 7
	static Pr_TaskRV_t 	EDROOMIRQ7BottomHalfTask(Pr_TaskP_t);
	//! Bottom Half Pr_Task Object for the IRQ vector 7
	Pr_Task 	EDROOMIRQ7BottomHalfT;
	//! Component Port associated to the IRQ vector 7
	static CEDROOMIRQInterface	RxTC;
	//! Global variable required for the botton half of the IRQ vector 7
	static CDTCDescriptor	EDROOMVarIRQ7;
	/**
	 * \class CEDROOMPOOLIRQ7CDTCDescriptor
	 * \brief Data Pool Class required for the botton half of the IRQ vector 7
	 *
	 */
	class CEDROOMPOOLIRQ7CDTCDescriptor:public CEDROOMProtectedMemoryPool {
		//! Data Pool Memory
		...
		public:
		//! Constructor
		CEDROOMPOOLIRQ7CDTCDescriptor():CEDROOMProtectedMemoryPool(10,mem,marks, sizeof(CDTCDescriptor)){}
	 ...
	 //!Data Pool required for the botton half of the IRQ vector 7
	static CEDROOMPOOLIRQ7CDTCDescriptor	EDROOMPoolIRQ7;

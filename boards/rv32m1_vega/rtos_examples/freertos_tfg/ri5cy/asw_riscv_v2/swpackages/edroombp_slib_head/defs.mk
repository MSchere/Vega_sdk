...
# PROTECTED REGION ID(edroombp_slib_common_src) ENABLED START
...
# PROTECTED REGION ID(edroombp_slib_rtemsapi_4_8_impr_rtems_4_8_impr_any_any_any) ENABLED START

SRCS+=$(wildcard $(SWPACKAGE_FOLDER_NAME)/src/rtemsapi_4_8_impr/rtems_4_8_impr/*.cpp)

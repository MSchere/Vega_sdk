...
# PROTECTED REGION ID(edroomsl_slib_common_src) ENABLED START
...
# RTEMSAPI_4_8_impr_any_any_any_any

# PROTECTED REGION ID(edroomsl_slib_rtemsapi_4_8_impr_any_any_any_any) ENABLED START

SRCS+=$(wildcard $(SWPACKAGE_FOLDER_NAME)/src/rtemsapi_4_8_impr/*.cpp)

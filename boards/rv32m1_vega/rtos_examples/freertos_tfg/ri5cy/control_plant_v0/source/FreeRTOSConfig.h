...
#if defined(__riscv)
#define configMINIMAL_STACK_SIZE                ((unsigned short)0x100)
#else
...
//#define configTOTAL_HEAP_SIZE                   ((size_t)(10 * 14.8 * 1024 ))
#define configTOTAL_HEAP_SIZE                   ((size_t)(10 * 14 * 1024 ))
 ...
 * ISR for the interrupt with higher priority than this value should not
 * call kernel APIs.
 */
#define configMAX_SYSCALL_INTERRUPT_PRIORITY configLIBRARY_MAX_SYSCALL_INTERRUPT_PRIORITY

#define configBASE_INT_PRIO_REG (0xe0041024)
...
#define FreeRTOS_SVC_Handler Ecall_Handler
#define FreeRTOS_Tick_Handler LPIT0_IRQHandler

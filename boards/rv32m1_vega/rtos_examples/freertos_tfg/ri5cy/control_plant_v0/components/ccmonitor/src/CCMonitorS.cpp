...
CCMonitor::CCMonitor(TEDROOMComponentID id,
...
void CCMonitor::EDROOMBehaviour()
{
...
bool CCMonitor::EDROOMIsComponentFinished()
{
...
void CCMonitor::CEDROOMMemory::SetMemory(TEDROOMUInt32 numMessages_ ,

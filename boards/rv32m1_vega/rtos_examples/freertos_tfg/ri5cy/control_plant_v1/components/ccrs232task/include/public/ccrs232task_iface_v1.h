#ifndef CCRS232TASK_H_
#define CCRS232TASK_H_
 ...
 *
 */
class CCRS232Task: public CEDROOMComponent {

public:

	/**
	 * \enum TEDROOMCCRS232TaskSignal
	 * \brief Component Signal Enum Type
	 *
	 */
	 enum TEDROOMCCRS232TaskSignal { EDROOMSignalTimeout, 
							EDROOMSignalDestroy, 
							SIamAlive, 
							SUpdateControlParam, 
							SNewChar };
	...
	/**
	 * \class CCRS232Task::CEDROOMMemory
	...
	//! Constructor
	CCRS232Task(TEDROOMComponentID id, TEDROOMUInt32 roomNumMaxMens, TEDROOMPriority roomtaskPrio, 
...
public:
	...
	enum TEDROOMCCRS232TaskSignal { EDROOMSignalTimeout,
		...
		friend class CCRS232Task;

		//!component reference
		CCRS232Task &EDROOMcomponent;
		...
		//!Constants
		const TEDROOMUInt8 CRS232_SCAN_ID;


		//!Variables
		TEDROOMUInt8 &VAuxIndex;
		TEDROOMByte *VAuxRS232Channel;
		...
		//!Constructor
		EDROOM_CTX_Top_0 (CCRS232Task &act,
	...
	protected:
		...
		//!Variables
		TEDROOMUInt8 VAuxIndex;
		TEDROOMByte VAuxRS232Channel[40];
	...
	public:
		...
		//! Constructor
		EDROOM_SUB_Top_0 (CCRS232Task &act, CEDROOMMemory *pEDROOMMemory  );

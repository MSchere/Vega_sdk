...
CCHTTPServerTask::CCHTTPServerTask(TEDROOMComponentID id,
...
int CCHTTPServerTask::EDROOMConfig()
{
...
int CCHTTPServerTask::EDROOMStart()
{
...
void CCHTTPServerTask::EDROOMBehaviour()
{
...
bool CCHTTPServerTask::EDROOMIsComponentFinished()
{
...
void CCHTTPServerTask::CEDROOMMemory::SetMemory(TEDROOMUInt32 numMessages_ ,
